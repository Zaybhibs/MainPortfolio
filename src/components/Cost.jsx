...
const Cost = () => {
  return (
    <div className="relative left-5 md:left-12 xl:left-14 top-32 lg:top-[50px] xl:top-[850px] mb-20">
        ...
        <div className="">
          <div className="md:flex items-center xl:gap-16 lg:gap-7">
            <div className="md:text-xl  font-bold ">
              ...
              <h2 className="text-2xl md:text-lg xl:text-xl">
            ...
            <div
              ...
              className="md:w-[500px] xl:w-[700px] w-[350px]  md:text-lg xl:text-xl font-medium "
            >
              <p>
        ...
        <div className="">
          <div className="md:flex items-center xl:gap-16 lg:gap-7">
            <div className="md:text-2xl font-bold">
              ...
              <h2 className="text-2xl md:text-lg xl:text-xl"> And after?</h2>
            </div>
            <div className="w-10">
              <hr className="border-t-2 border-black" />
            </div>
            <div className="md:w-[500px] xl:w-[700px] w-[350px]  md:text-lg xl:text-xl md:pl-4 font-medium ">
        ...
        <div className="">
          <div className="md:flex items-center xl:gap-16 lg:gap-7">
            <div className="md:text-2xl font-bold">
              ...
              <h2 className="text-2xl md:text-lg xl:text-xl">Sleep well</h2>
            </div>
            <div className="w-10">
              <hr className="border-t-2 border-black" />
            </div>
            <div className=" md:w-[500px] xl:w-[700px] w-[350px]   xl:text-xl md:pl-5 md:text-xl font-medium ">
              <p data-aos="fade-up-left" data-aos-duration="700">
